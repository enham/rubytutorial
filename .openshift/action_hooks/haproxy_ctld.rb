...
class Haproxy
    ...
    def check_capacity(debug=nil)
        ...
        if lsets == 0 || lsets > FLAP_PROTECTION_TIME_SECONDS
          ...
          # To get a gear list, we can read the gear registry.  It contains a
          # list of all of our gears in a json consumable format
          ...
          # Scale up when any gear is using 1M or more memory.
          mem_scale_up = 10000

          # Scale down when any gear is using .5M or less memory
          mem_scale_down = 5000
